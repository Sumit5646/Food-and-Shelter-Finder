...
<main>
    ...
    ?>
            ...
            <div class="col">
              ...
              <div class="card">
                <img class="life" src="<?php echo $row["fimage"]; ?>"alt="...">
                    <div class="card-body">
                    <h4>Venue Name: <?php echo $row["fbname"]; ?></h4>
                    <h3 class="card-title"><?php echo $row["fname"]; ?></h3>
                    <p class="card-text"><?php echo $row["fdis"]; ?></p>
                    <h6>Price: <?php echo $row["fprice"]; ?></h6>
                    <details>Address: <?php echo $row["fadd"]; ?> <h6>Phone Number: <?php echo $row["fphone"]; ?></h6><h6><a href="<?php echo $row ["image"];?>">Location</a></h6></details>
